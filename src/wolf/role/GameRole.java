...
public abstract class GameRole {
  ...
  private final BotAction voteAction = new BotAction(1) {
    ...
    protected void execute(WolfBot bot, String sender, String command, List<String> args) {
      ...
      getEngine().getBot().sendMessage(sender,
          "Your vote for " + voteTarget.getName() + " has been received.");
  ...
  public static final List<Class<? extends GameRole>> roles = Lists.newArrayList(Civilian.class,
      Hunter.class, Priest.class, Seer.class, Vigilante.class, Wolf.class, Demon.class, Twin.class,
      Anarchist.class);
